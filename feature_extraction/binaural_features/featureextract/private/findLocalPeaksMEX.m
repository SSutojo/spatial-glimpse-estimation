function varargout = findLocalPeaksMEX(varargin)
%findLocalPeaksMEX   Private method, which is normally shadowed by the
...
error(['MEX function "',mfilename,'" is not available for your ',...
       'operating system (',computer,'). Run "compileMEX" to built ',...
