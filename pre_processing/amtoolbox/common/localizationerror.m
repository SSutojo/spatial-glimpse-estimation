...
%                          the most responses / excludes the least outliers.
%                          Outlier distance criterion: 40deg. 
%                          Output parameters [f,r] correspond to regression
...
%
%   Url: http://amtoolbox.org/amt-1.1.0/doc/common/localizationerror.php
