function varargout = comp_may2011_xcorrnorm(varargin)
%comp_xcorrNorm   Private method, which is normally shadowed by the
%   corresponding MEX routine. It will ONLY be executed, if the underlying
%   MEX routine is not available.  
%
%   Url: http://amtoolbox.org/amt-1.1.0/doc/mex/comp_may2011_xcorrnorm.php
