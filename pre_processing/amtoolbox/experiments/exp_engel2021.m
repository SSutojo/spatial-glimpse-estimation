...
%
%   WARNINGS:
%   - The HRTF data (hnm) is fairly large (~9GB) and may take several 
...
%     exp_engel2021('fig7');
%   
%   EXTERNAL DEPENDENCIES (you will need these in your Matlab path):
%   BinauralSH (github.com/isaacengel/BinauralSH)
%
%   Url: http://amtoolbox.org/amt-1.1.0/doc/experiments/exp_engel2021.php
...
SOFA_obj = SOFAload(fullfile(SOFAdbPath,'engel2021',[hrirname,'.sofa']));
