...
%   vice-versa.
%
%   Url: http://amtoolbox.org/amt-1.1.0/doc/core/amt_configuration.php
   ...
   if ischar(varargin{1})
       switch varargin{1}
        ...
        otherwise
          ...
          elseif strcmp(varargin{ii}, 'global') || strcmp(varargin{ii}, 'normal') || strcmp(varargin{ii}, 'redo') || strcmp(varargin{ii}, 'localonly')
