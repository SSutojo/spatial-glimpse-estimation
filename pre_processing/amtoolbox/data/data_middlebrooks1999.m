...
%
%   Output parameters:
%     data.le_own   : local lateral RMS error (LE) when localizing with own
%                     HRTFs
%     data.le_other : LE when localizing with others' HRTFs
%     data.lb_own   : magnitude of lateral bias (LB) when localizing with own
%                     HRTFs; upper-rear quadrant excluded from analysis
%     data.lb_other : LB when localizing with others' HRTFs
...
%     
%
%   Url: http://amtoolbox.org/amt-1.1.0/doc/data/data_middlebrooks1999.php
