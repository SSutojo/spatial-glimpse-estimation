...
%   Examples:
%
%   1. Anechoic signal (rendered with HRTFs or direct sound part of BRIRs)
%   E = Li2020(tar_HRIR,tem_HRIR,[],[],'stim',stimulus,'fs',44100,'fsstim',44100,'flow',200, 'fhigh',16000, 'space',1);  
%
%   2. Reverberant signal (rendered with BRIRs with unkonwn direct sound part)
%   E = Li2020([],[],tar_BRIR,tem_BRIR,'stim',stimulus,'fs',44100,'fsstim',44100,'flow',200, 'fhigh',16000, 'space',1);  
%
%   3. Reverberant signal (rendered with BRIRs with konwn direct part (HRTFs))
...
%     
%
%   Url: http://amtoolbox.org/amt-1.1.0/doc/models/li2020.php
...
%   #Author: Song Li, Institute of Communications Technology, Leibniz University of Hannover, Germany
