...
%               sampling)
%     tang    : polar target angles (useful if sagittal-plane HRTFs are
...
%     
%
%   Url: http://amtoolbox.org/amt-1.1.0/doc/models/baumgartner2016.php
...
definput.import={'baumgartner2016'}; % import default settings from arg_baumgartner2016
...
if kv.do == 1 && flags.do_psge
  ...
  amt_disp('Cue extraction different to baumgartner2014');
...
if flags.do_isd && not(flags.do_intensityweighting) && not(flags.do_diff)
  ...
  amt_disp('Comparison process different to baumgartner2014');
...
if flags.do_isd && flags.do_sigmoid
  ...
  amt_disp('Similarity estimation different to baumgartner2014');
