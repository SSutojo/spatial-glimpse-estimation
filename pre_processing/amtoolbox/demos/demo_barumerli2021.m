...
%
%   Url: http://amtoolbox.org/amt-1.1.0/doc/demos/demo_barumerli2021.php
...
%   See also: barumerli2021 exp_barumerli2021 
...
[template, target] = barumerli2021_featureextraction(sofa_obj, 'pge');
...
target_single = barumerli2021_featureextraction(sofa_obj, 'pge', 'target','targ_az', targ_az, 'targ_el', targ_el);

% simulate single estimation process
[m, doa, doa_real] = barumerli2021(...
                'template', template, ...
