% demo_mckenzie2021 demonstrates the use of the mckenzie2021 model: 
...
%
%   Figure 4: Spectral difference for all stimuli single values
%
%
%   As referred to in the Acta Acustica
%   paper: McKenzie, T., Armstrong, C., Ward, L., Murphy, D. T., & Kearney,
%   G. (2021). A Perceptually Motivated Spectral Difference Model for
%   Binaural Signals. Acta Acustica (in review).
%
%   Url: http://amtoolbox.org/amt-1.1.0/doc/demos/demo_mckenzie2021.php
...
[~,PSpecDiff] = mckenzie2021(tsP,rsP,domFlag,f,datasetNormalisation);
...
% plot values
plot_mckenzie2021(PavgSpecDiffS,testDirections);
...
% Calculate perceptual spectral difference
[~,PSpecDiff] = mckenzie2021(tsF,rsF,domFlag,f,datasetNormalisation,w,normalisationPlotFlag,normalisationResolution);
PSpecDiff = squeeze(PSpecDiff);
