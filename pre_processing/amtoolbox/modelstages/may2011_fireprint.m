function cmap=may2011_fireprint(n,varargin)
%MAY2011_FIREPRINT Colormap that increases linearly in lightness (with colors)
%
%   Usage:
...
%     colorbar
%
%   Url: http://amtoolbox.org/amt-1.1.0/doc/modelstages/may2011_fireprint.php
