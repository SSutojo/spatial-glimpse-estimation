...
%   Usage: metrics = barumerli2021_metrics(m, 'middle_metrics') 
%           metrics = barumerli2021_metrics(m, metric) 
%
%   Input parameters:
%     m       : (matrix) table organized as in localizationerror with actual
%                   and predicted directions. The model barumerli2021 can
%                   output directly such matrix.
%     metric  : (string) string indicating which metric has to be computed.
%     For a complete list, please consider localizationerror. Moreover,
...
%   used internally in barumerli2021 which behavior is not here
%   described. 
%
