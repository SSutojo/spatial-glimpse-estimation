...
%lyon2011_design computes all the filter coefficients needed to run Lyon's CARFAC model
%
%   Usage:
...
%
%   Url: http://amtoolbox.org/amt-1.1.0/doc/modelstages/lyon2011_design.php
...
% for unity gain at min damping, radius r; only used in lyon2011_init:
...
if IHC_params.just_hwr
  ...
  if IHC_params.one_cap
    ro = 1 / lyon2011_detect(10);  % output resistance at a very high level
...
% like this, before lyon2011_init puts state storage into it:
%
