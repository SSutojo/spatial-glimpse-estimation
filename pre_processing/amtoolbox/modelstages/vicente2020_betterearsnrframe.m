...
%
%   compute IN ALL frequency bandS centered at fc, the BE SNR, after considering audiogramme, applying ceiling.
%   int_in is ear signals (in a time-frame)
%   t_left/right are (longterm) power of the target at that ear in this band, t_phase is its corresponding interaural phase
%   fs=sampling frequency
%
%   Url: http://amtoolbox.org/amt-1.1.0/doc/modelstages/vicente2020_betterearsnrframe.php
