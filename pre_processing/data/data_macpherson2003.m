...
%
%   Output parameters:
%     data.density  : probed ripple densities in ripples/oct (Exp. I)
%     data.depth    : probed ripple depths (peak-to-trough) in dB (Exp. II)
%     data.phase    : probed ripple phases in radians (Exp. III)
%     data.pe_flat  : PER for flat spectrum
%     data.pe_exp1  : increase in PER as a function of ripple density at 
%                     a ripple depth of 40dB 
%                     (col. 1: 0-phase, col. 2: pi-phase)
%     data.pe_exp2  : increase in PER as a function of ripple depth at 
...
%     
%
%   Url: http://amtoolbox.org/amt-1.1.0/doc/data/data_macpherson2003.php
