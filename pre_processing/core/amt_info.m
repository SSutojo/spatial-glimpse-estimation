...
%
%   Input parameters:
%      'modelname'    : search pattern (typically the name of the first
%                       author) associated to a model. 
%      'once'         : can only be called from within a model or modelstage.
...
%
%   Url: http://amtoolbox.org/amt-1.1.0/doc/core/amt_info.php
